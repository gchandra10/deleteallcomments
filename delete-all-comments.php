<?php
    ...
    Description: Plugin to delete all comments (Approved, Pending, Spam). Tested upto wordpress 4.8
...
?>
    <div class="wrap">
        ...
        if(isset($_POST['chkdelete']) == 'Y'){
            ...
            echo "<table summary='table to display comment status' cellpadding='1' cellspacing='1' border='0'>";
            echo "<tr>" . "<td><strong>" . " Wordpress Site Name : " . "</strong></td><td>&nbsp;&nbsp;</td>" . "<td><strong>" . $current_site . "</strong></td>" . "</tr>";
            ...
            foreach ($result as $comment) {
                switch ($comment->comment_approved){
                    case '0':
                        echo "<tr>" . "<td><em>" . " <li> Unapproved Comments </li>" . "</em></td><td>&nbsp;&nbsp;</td>" . "<td>" . $comment->cnt . "</td>" . "</tr>";
                        break;
                    case 'spam':
                        echo "<tr>" . "<td><em>" . " <li> Spam Comments </li>" . "</em></td><td>&nbsp;&nbsp;</td>" . "<td>" . $comment->cnt . "</td>" . "</tr>";
                        break;
                    case 'trash':
                        echo "<tr>" . "<td><em>" . " <li> Deleted Comments </li>" . "</em></td><td>&nbsp;&nbsp;</td>" . "<td>" . $comment->cnt . "</td>" . "</tr>";
                        break;
                    case 'post-trashed':
                        echo "<tr>" . "<td><em>" . " <li> Comments from Deleted posts </li>" . "</em></td><td>&nbsp;&nbsp;</td>" . "<td>" . $comment->cnt . "</td>" . "</tr>";
                        break;
                    case '1':
                        echo "<tr>" . "<td><em>" . " <li> Approved Comments </li>" . "</em></td><td>&nbsp;&nbsp;</td>" . "<td>" . $comment->cnt . "</td>" . "</tr>";
                        break;
                }
            }
            echo "</table>";
        ...
        <p>
            <strong>Note: Please check the box below and click Delete All Comments button.</strong></p>
            <form name="frmOviamdac" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
                ...
                <input type="checkbox" name="chkdelete" value="Y" /> I agree to delete all comments from "<strong><?php echo($current_site) ?></strong>" website.
                <p class="submit">
		            <input type="submit" name="Submit" value="Delete All Comments" />
                </p>
                <p>
                    <em><u>Tech bit</u>: Truncates Commentsmeta, Comments table and Optimizes them. Also resets the comment count in post table.</em>
                </p>
                <p>
                    <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=X6Z2BBNERP6V2"><b>Donate via PayPal</b></a></em>
                </p>
            </form>
        <?php
